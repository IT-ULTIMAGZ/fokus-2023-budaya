  ...
  return(
    <div class='page flex-column justify-center align-center' style={styles}>
      <div  data-aos='fade-right-custom'class='flex-row justify-around align-center' style={{gap:'5vw'}}>
        ...
        <div className="flex-column justify-center align-center"style={{width:'37vw',gap:'3vh'}}>
          ...
          <p data-aos='fade-right-custom' data-aos-delay='1000' style={{width:'100%',textAlign:'justify',fontFamily:'National2Medium',fontSize:'calc(22/1920*100vw)',color:"#F4F3D3"}}alt="" class='detail-text-2'> Selain budaya yang mengikuti perkembangan zaman, masyarakat juga harus tetap menghormati keberagaman budaya yang ada di nusantara. Tidak semua budaya nusantara memiliki ciri khas dan nilai yang sama serta dapat beradaptasi dengan perkembangan masa kini.
            <br /><br />
