import './css/part11.css';

const Part11 = () => {

    return (
        <div className="part11Section" id="abahEngkus" data-scroll-section>
            ...
            <div className='part11SectionKanan' >
                <p data-aos='fade-up-custom'>Pada saat ia mencapai usia kepala dua, tepatnya pada 1975, Abah Engkus menyelenggarakan <br />
                    ...
                    Tidak hanya itu, mereka juga menunjukkan <b>seni debus Banten</b>. </p>
            
                <br />
                <p data-aos='fade-up-custom' data-aos-delay='0.3'>Melansir dari <i>gramedia.com</i>, <b>debus</b> merupakan seni tradisional asal Banten yang menunjukkan <br />
                    ketahanan seseorang saat benda tajam yang melukai tubuhnya.    </p>
            </div>
        </div>
    )
}
