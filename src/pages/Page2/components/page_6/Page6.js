    ...
    return (
        <div className="background6">
            <div className="tulisan6">
                <div className="isi6">
                    <p>Penggunaan dan pemaknaan masyarakat terhadap kain tradisional sejak dahulu membuat kain menjadi <br />
                    ...
                    <p>The United Nations Educational, Scientific and Cultural Organization (UNESCO) mengakui batik sebagai <br />
                    ...
                    <p>Namun, perlu diingat kembali bahwa ada berbagai macam kain dari setiap wilayah di Indonesia selain batik.<br />
